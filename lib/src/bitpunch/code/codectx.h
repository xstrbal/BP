...
#include <bitpunch/code/qcldpc/qcldpctypes.h>
...
/**
 * Wrapper for param initialization. After work you have to free memory using call BPU_codeFreeParamsQcldpc
 * @param  params pointer to structure
