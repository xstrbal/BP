...
/**
* Create a binary vector of required length. Every bit is set to 1 with probability prob except for the last parity bit. 
* Parity bit is set according to parity. After work call BPU_freeVecGF2
* @param  out GF2 vector representation (L)
* @param prob probability of setting bit to 1, interval <0,1>
* @param parity, 0 - odd parity, nonzero - even parity
* @return     0 - succes, else error
*/
...
/**
* Initialize random polynomial. Every bit is set to 1 with probability prob except for the last parity bit. 
* Parity bit is set according to parity. After work you have to free memory using call BPU_gf2PolyFree.
* @param out output polynomial
* @param l length of polynomial (length - 1 = degree of polynomial)
* @param prob, probability of setting bit to 1, interval <0,1>
* @param set_deg boolean param, if 1, it will crop polynomial to the actual degree and reallocate it
* @param parity, parity==0 -> odd, parity==nonzero->even
* @return 0 - succes, else error
*/
